...
/**
 * Modal component for uploading a new game from JSON file
 */
    ...
    >
      ...
      <DialogContent>
        <Typography variant="body1" sx={{ mb: 3 }}>
          Upload a JSON file containing a complete game structure to create a
          new game.
        </Typography>
        ...
        {fileContent && (
          <Alert severity="success" sx={{ mb: 3 }}>
            File validated successfully. Ready to create game:{' '}
        ...
        <Typography variant="body2" color="text.secondary">
          ...
          question structure. See the documentation or sample file for the
          expected format.
        </Typography>
      </DialogContent>
